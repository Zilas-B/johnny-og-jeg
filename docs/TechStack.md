...
This document defines the technology choices for the Johnny og Jeg website. It is the source of truth for all stack decisions; if a step in `Metaplan.md` conflicts with this document, this document wins until updated.
